...
def render(viewpoint_camera, pc: GaussianModel, deform_model, pipe, bg_color: torch.Tensor, scaling_modifier=1.0, separate_sh=False,
    ...
    if t is not None:
        d_xyz, d_scaling, d_rotation, d_weights =  deform_model.deformation(pc, t)
        means3D += d_xyz
