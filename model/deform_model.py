...
class DeformModel:
    def __init__(self, cfg):
        ...
        self.mlp_head = simple_network(self.deform_HASH.n_output_dims,self.hidden_dim, self.n_w , cfg["num_layer"]).cuda()
    ...
    def deformation(self, pc, t):
        ...
        d_xyz = deform_[...,:3]
        d_scaling = None
        d_rotation = tr.rotation_conversions.axis_angle_to_quaternion(deform_[...,3:6])
    ...
    def training_setting(self):
        ...
        l = [
            {'params': self.deform_HASH.parameters(), 'lr': 0.01* self.spatial_lr_scale, "name": "deform_HASH", "weight_decay": eval(self.cfg["weight_decay"])},
            {'params': self.mlp_head.parameters(), 'lr': 0.001, "name": "mlp_head", "weight_decay": eval(self.cfg["weight_decay"])},
