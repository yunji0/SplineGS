...
def loadCam(cfg, id, cam_info, resolution_scale):
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T,
                  ...
                  data_device=cfg["data_device"] , fid=cam_info.fid,
                  depth=cam_info.depth, image_path= cam_info.image_path)


def cameraList_from_camInfos(cam_infos, resolution_scale, cfg):
    camera_list = []

    for id, c in enumerate(cam_infos):
        camera_list.append(loadCam(cfg, id, c, resolution_scale))
